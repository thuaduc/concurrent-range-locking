...
const int num_transactions_per_thread = 2000;
...
auto benchmark_v0(int num_threads, int num_transactions_per_thread) {
    ...
    for (int i = 0; i < num_threads; ++i) {
        threads.emplace_back(database_transaction_v0, std::ref(crl), i,
...
auto benchmark_v1(int num_threads, int num_transactions_per_thread) {
    ...
    for (int i = 0; i < num_threads; ++i) {
        threads.emplace_back(database_transaction_v1, std::ref(list), i,
                             num_transactions_per_thread);
    }
